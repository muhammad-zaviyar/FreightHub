            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">Form Advanced</h1>
                                ...
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <input name='tags-disabled-user-input' placeholder='Select tags from the list' class="form-control" value="1">
                                        </div>
                                        <div class="col-xl-6">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <input
                                            name='readonly-mix' class="form-control"
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <textarea name='mix' class="form-control">[[{"id":101, "value":"cartman", "title":"Eric Cartman"}]] and [[kyle]] do not know [[{"value":"homer simpson", "readonly":true}]] because he's a relic.</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
