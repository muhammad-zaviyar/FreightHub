                                ...
                                <div class="card-body">
                                    <div class="swiper swiper-basic">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide"><img src="{{asset('build/assets/images/media/media-22.jpg')}}" alt=""></div>
                                ...
                                <div class="card-body">
                                    <div class="swiper pagination-dynamic">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide"><img src="{{asset('build/assets/images/media/media-11.jpg')}}" alt=""></div>
                                            <div class="swiper-slide"><img src="{{asset('build/assets/images/media/media-10.jpg')}}" alt=""></div>
                                        </div>
                                        <div class="swiper-pagination"></div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="swiper pagination-progress">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide"><img src="{{asset('build/assets/images/media/media-6.jpg')}}" alt=""></div>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="swiper swiper-fade">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{asset('build/assets/images/media/media-15.jpg')}}" alt="img">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{asset('build/assets/images/media/media-16.jpg')}}" alt="img">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{asset('build/assets/images/media/media-17.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                        <div class="swiper-button-next"></div>
                                        <div class="swiper-button-prev"></div>
