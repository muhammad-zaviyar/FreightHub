                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <nav class="navbar navbar-expand-lg navbar-primary mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);">
                                                <img src="{{asset('build/assets/images/brand-logos/toggle-white.png')}}" alt="">
                                            </a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="{{asset('build/assets/images/brand-logos/toggle-white.png')}}" alt=""></a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
