                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="order-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="home-tab-pane" aria-selected="true"><i
                                                class="ri-gift-line me-1 align-middle tab-style-2-icon"></i>Ordered</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="confirmed-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="profile-tab-pane" aria-selected="false"><i
                                                class="ri-check-double-line me-1 align-middle tab-style-2-icon"></i>Confirmed</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="shipped-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="contact-tab-pane" aria-selected="false"><i
                                                class="ri-shopping-bag-3-line me-1 align-middle tab-style-2-icon"></i>Shipped</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="delivered-tab" data-bs-toggle="tab"
                                            data-bs-target="#delivered-tab-pane" type="button" role="tab" aria-selected="false"><i
                                                class="ri-truck-line me-1 align-middle tab-style-2-icon"></i>Delivery</button>
                                    </li>
                                </ul>
                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">
                                                            <span class="avatar avatar-sm bg-primary-transparent">
                                                                <img src="{{asset('build/assets/images/ecommerce/png/26.png')}}" alt="img">
                                                            </span>
                                                        </th>
                                                        <td>Alarm Clock</td>
                                                        <td>Clocks</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <span class="avatar avatar-sm bg-primary-transparent">
                                                                <img src="{{asset('build/assets/images/ecommerce/png/9.png')}}" alt="img">
                                                            </span>
                                                        </th>
                                                        <td>Sport Shoes</td>
                                                        <td>Footwear</td>
