                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="{{asset('build/assets/images/media/media-18.jpg')}}" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="{{asset('build/assets/images/media/media-20.jpg')}}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-medium">Card title</h6>
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="{{asset('build/assets/images/media/media-19.jpg')}}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and
                                        make up the bulk of the card's content.</p>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="{{asset('build/assets/images/media/media-7.jpg')}}" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-title fw-medium mb-3">Nature<span class="badge bg-pink float-end fs-10">Offer</span></h6>
                                    <p class="card-text">With supporting text below as a natural
                                        lead-in.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-12">
                            ...
                            <div class="row row-cols-12">
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="{{asset('build/assets/images/media/media-22.jpg')}}" class="card-img mb-3" alt="...">
                            ...
                            <div class="card border border-light custom-card">
                                <div class="card-body">
                                    <p class="fs-14 fw-medium mb-2 lh-1">New Employees
                                        <a href="javascript:void(0);"><i class="bi bi-plus-square float-end text-gray-5 fs-18"></i></a>
                                    </p>
                                    <div class="d-flex flex-wrap gap-2 mb-4">
                                        <span class="badge bg-warning-transparent">Html</span>
