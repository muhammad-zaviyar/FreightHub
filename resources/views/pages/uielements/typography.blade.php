                                ...
                                <div class="card-body">
                                    <div class="p-1 border border-success rounded">
                                        <blockquote class="blockquote custom-blockquote primary mb-0 text-center">
                                            ...
                                            <footer class="blockquote-footer mt-3 text-primary mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
                                        </blockquote>
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;div class="p-1 border border-success rounded"&gt;
&lt;blockquote class="blockquote custom-blockquote primary mb-0 text-center"&gt;
    &lt;h5&gt;The future belongs to those who believe in the beauty of their dreams..&lt;/h5&gt;
    &lt;footer class="blockquote-footer mt-3 text-primary mb-0"&gt;Someone famous as &lt;cite title="Source Title"&gt;-Eleanor Roosevelt&lt;/cite&gt;&lt;/footer&gt;
                                ...
                                <div class="card-body">
                                    <div class="p-1 border border-success rounded">
                                        <blockquote class="blockquote custom-blockquote secondary mb-0 text-center">
                                            <h5>The future belongs to those who believe in the beauty of their dreams..</h5>
                                            <footer class="blockquote-footer mt-3 text-secondary mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
                                        </blockquote>
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
