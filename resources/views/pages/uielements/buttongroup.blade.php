                                    ...
                                    <div class="col-sm-3">
                                        <div class="btn-group-vertical" role="group"
                                            ...
                                            <input type="radio" class="btn-check" name="vbtn-radio" id="vbtn-radio1"
                                                checked="">
                                            <label class="btn btn-outline-success" for="vbtn-radio1">Radio 1</label>
                                            <input type="radio" class="btn-check" name="vbtn-radio" id="vbtn-radio2"
                                               >
                                            <label class="btn btn-outline-success" for="vbtn-radio2">Radio 2</label>
                                            <input type="radio" class="btn-check" name="vbtn-radio" id="vbtn-radio3"
                                               >
                                            <label class="btn btn-outline-success" for="vbtn-radio3">Radio 3</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
