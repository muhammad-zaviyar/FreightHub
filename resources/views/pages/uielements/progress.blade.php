                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="progress progress-sm" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                        <div class="progress-item-1 bg-pink"></div><div class="progress-item-2 bg-pink"></div><div class="progress-item-3 bg-pink"></div>
                                        <div class="progress-bar bg-pink" style="width: 90%"></div>
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
