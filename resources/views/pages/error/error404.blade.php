                        ...
                        <div class="my-auto">
                            <div class="row align-items-center justify-content-center h-100">
                                <div class="col-xl-10 col-lg-5 col-md-6 col-12 text-fixed-white">
                                    <div>
                                        <p class="error-text">4<span class="text-secondary">0</span>4</p>
                                        <p class="fs-20 fw-semibold mb-0 op-9">Page Not Found...</p>
                                        <p class="fs-14 mb-5 text-fixed-white op-7 fw-normal">Sorry, the page you're looking for doesn't exist. It may have been moved, deleted, or the URL could be incorrect.</p>
